...
include '../../Includes/generateQR.php';
...
$sql = "SELECT user_identity_token from users WHERE uid  = '$uid'";
$result = mysqli_query($con, $sql);
$row = mysqli_fetch_assoc($result);
$userIdToken = $row['user_identity_token'];

//Get User Details
$query = "SELECT name,email,mobileNumber from user_details WHERE uid  = '$uid'";
            ...
            <div class="row bodyRow">
                    ...
                    <div class="card userDetailsCard">
                        ...
                        <div class="row">
                            <div class="col cardNumberColumn">
                                <p class="card-text customerNumber"><?php echo $userMobile ?></p>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="col-sm-7 offset-sm-1">
                    <div class="card userRecentTripsCard">
                        ...
                        <div class="card-body">
                            <?php
                            while ($a < 4 && $row = mysqli_fetch_assoc($results)) {
                            ...
                            <div class="row">
                                <div class="col viewMoreBtnColumn">
                                    <a href="trips.php"><button type="button" class="btn btn-primary viewAllBtn">VIEW ALL</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 columnQR">
                        <div class="card qrCodeCard">
                            <form action="" method="POST">
                                <div class="card-body generateQR">
                                    <img src="../../Images/QRCodes/<?php echo $userIdToken ?>.png" alt="">
                                </div>
                                <input type="hidden" name="useridtoken" value="<?php echo $userIdToken ?>">
                                <div class="card-footer text-center">
                                    <button type="submit" class="btn btn-info" name="generateQR">Generate My QR Code</button>
                                    <a href="../../Images/QRCodes/<?php echo $userIdToken ?>.png" download="QRCode.png" class="btn btn-warning">Download</a>
                                </div>
                            </form>
                        </div>
                    </div>
